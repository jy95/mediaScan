...
export function filterDefaultStringProperties(searchObject: MediaScanTypes.DefaultSearchParameters)
...
export function filterByString(set: Set<MediaScanTypes.TPN>,
                               propertiesMap: Map<string, string | string[]>): Set<MediaScanTypes.TPN> {
