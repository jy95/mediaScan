...
export function filterDefaultBooleanProperties(searchObject: MediaScanTypes.DefaultSearchParameters)
...
export function filterByBoolean(set: Set<MediaScanTypes.TPN>, propertiesMap: Map<string, boolean>)
